...
buildOne ()
{
    ...
    local spirv_headers_dir=${DEPLOY_BASE_DIR}/spirv_headers/linux${addressmode}/${configuration}
    ...
    cmake                                                  \
        ...
        -DVULKAN_HEADERS_INSTALL_DIR=${vulkan_headers_dir} \
        -DSPIRV_HEADERS_INSTALL_DIR=${spirv_headers_dir}   \
