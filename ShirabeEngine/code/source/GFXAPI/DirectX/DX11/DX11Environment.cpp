    ...
    namespace _11 {
          ...
          RendererConfiguration  const& configuration)
      {
              ...
              &configuration] () -> void
        {
          ...
          status = DX11DeviceCapsHelper::GetDeviceCapabilities(Format::RGBA_8_UNORM, &m_caps);
          HandleEngineStatusError(status, "Failed to retrieve device capabilities.");
            ...
            std::function<void()> fnCreateDeviceSwapChainImmediateContext
              = [this,
              &applicationEnvironment,
              &configuration] () -> void
            {
              ...
              if(FAILED(hres)) {
                ...
                HandleEngineStatusError(status, "Failed to create device.");
              }
            ...
            try {
              ...
              fnCreateDeviceSwapChainImmediateContext();
      ...
      IDXGISwapChainPtr
        DX11Environment::getSwapChain()
      {
        return m_swapChain;
      }

      ID3D11DevicePtr
        DX11Environment::getDevice()
      {
        return m_device;
      }

      ID3D11DeviceContextPtr
        DX11Environment::getImmediateContext()
      {
