...
namespace Platform {
	namespace Windows {
		...
		IWindowPtr WindowsWindowFactory::createWindow(
			...
			HWND handle = WinAPIFunctions::__CreateWindow<WindowsWindow>(_instanceHandle, 
			...
			HWND __CreateWindow(
				...
				hwnd
					= CreateWindowEx(
						...
						initialBounds._position.x(),  // Bounds::Location::X
						initialBounds._position.y(),  // Bounds::Location::Y
						initialBounds._size.x(),      // Bounds::Size::X
						initialBounds._size.y(),      // Bounds::Size::Y
						NULL,                        // Parent HWND
						NULL,                        // Menu
