                                                                          ...
                                                                          , SBufferGenerationInputData const &aInputData)
        {
                                      ...
                                      , SRenderGraphRenderContext         &aRenderContext) -> CEngineResult<>
            {
                ...
                for(auto const &renderObject : aPassData.importData.renderObjects)
                {
                    ...
                    EEngineStatus const bUseMeshResult = aRenderContext.useMesh(aRenderContextState, mesh);
                    SHIRABE_UNUSED(bUseMeshResult);

                    for(SRenderGraphRenderObjectMaterial const &material : renderObject.materials)
                    {
