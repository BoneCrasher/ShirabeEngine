...
namespace engine
{
    namespace framegraph
    {
        ...
        public_constructors:
             ...
             */
            CGraphBuilder(CRHIResourceManager const &aResourceManager);
...
EST_EXPORT CGraphBuilder
        ...
        private_members:
            ...
            SRenderGraphPlatformContext                     mPlatformContext;
            SRenderGraphDataSource                          mGraphDataSource;

            CRHIResourceManager const &mResourceManager;
                ...
                TPassCreationArgs &&...  aArgs)
        {
            ...
            try
            {
                ...
                auto const &[status] = pass->setup(passBuilder, mPlatformContext, mGraphDataSource);
