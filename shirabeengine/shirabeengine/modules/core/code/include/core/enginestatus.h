...
namespace engine
{
            ...
            : int32_t
    {
        ...
        RenderGraph_PassBuilder_DuplicateTextureViewId                   = -500103,
        RenderGraph_PassBuilder_ForwardResourceFailed                    = -500104,
        RenderGraph_PassBuilder_AcceptResourceFailed                     = -500105,
        RenderGraph_PassBuilder_ReadResourceFailed                       = -500106,
        RenderGraph_PassBuilder_WriteResourceFailed                      = -500107,
        RenderGraph_PassBuilder_ImportRenderablesFailed                  = -500151,
        RenderGraph_RenderContext_AttachmentDimensionsInvalid            = -500501,
    };
