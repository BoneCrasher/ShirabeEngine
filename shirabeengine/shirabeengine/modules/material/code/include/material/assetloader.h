...
namespace engine
{
    ...
    namespace resources
    {
        ...
        template<>
        class CResourceDescDeriver<CMaterialInstance, SMaterialDescriptor>
        {
        public:
            static SMaterialDescriptor derive(Shared<CAssetStorage> aAssetStorage, Shared<CMaterialInstance> aInstance)
            {
                ...
                auto[derivationSuccessful, pipelineDescription, shaderModuleDescription, bufferDescriptions] = deriveResourceDescriptions(aAssetStorage
                                                                                                                                          , master->name()
                                                                                                                                          , master->signature()
                                                                                                                                          , aInstance->config()
