    ...
    private:
      ...
      static BOOL CALLBACK handleDisplayMonitor(HMONITOR monitor, HDC hdc, LPRECT rect, LPARAM param) {
        ...
        if(!GetMonitorInfo(monitor, &info)) {
          Log::Warning(logTag(), String::format("Cannot retrieve monitor info for monitor '{}'", monitor->unused));
          return FALSE;
        }
        else {
          ...
          Log::Status(logTag(), String::format("Found {} monitor '{}' with display area: Location: {}, {}; Size: {}, {}",
