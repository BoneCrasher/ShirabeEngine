    ...
    namespace Windows {
      ...
      EEngineStatus WindowsWindow::show() {
        try {
          ...
          Log::Error(logTag(), String::format("Failed to show window '{}'", name()));
      ...
      EEngineStatus WindowsWindow::hide() {
        try {
          ...
          Log::Error(logTag(), String::format("Failed to hide window '{}'", name()));
          return EEngineStatus::WindowEventError;
        }
      }
      ...
      EEngineStatus WindowsWindow::update() {
        ...
        try {
          ...
          Log::Error(logTag(), String::format("Failed to update message queue of window '{}'", name()));
      ...
      LRESULT CALLBACK WindowsWindow::WndProc(HWND handle, UINT message, WPARAM wparam, LPARAM lparam) {
        ...
        default:
          // Log::Verbose(logTag(), String::format("Unhandled message '{}'. Fwd to default handler.", message));
          goto unhandled;
          break;
        }
