...
namespace Engine {
	namespace Math {
		...
		{
		public:
            typedef MatrixRowIterator<T> class_type;
            ...
            value_type *ptr() { return m_row; }
            const_value_type const_ptr() const { return const_cast<const_value_type>(m_row); }

			inline const_value_type operator[](size_t index) {
                // if (index >= m_n)
                // 	throw new std::invalid_argument("Index out of accessor bounds.");

                return const_cast<const_value_type>(*(m_row + index));
			}
		private:
			value_type* m_row;
			size_t      m_row_off;
		...
		{
        public:
            typedef Field <float, sizeof(float), (row_count * col_count), col_count> base_type;
            typedef typename base_type::value_type value_type;
            typedef Matrix<row_count, col_count> class_type, matrix_type;
            typedef Matrix<col_count, row_count> transposed_matrix_type;
		public:
