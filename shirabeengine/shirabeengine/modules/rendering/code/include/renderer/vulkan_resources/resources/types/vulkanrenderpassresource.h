...
namespace engine
{
    ...
    namespace resources
    {
        template <> struct SLogicalToGpuApiResourceTypeMap<SRenderPass> { using TGpuApiResource = vulkan::SVulkanRenderPassResource; };
    }
    ...
    namespace vulkan
    {
        ...
        struct SVulkanRenderPassResource
        {
            ...
            static EEngineStatus initialize(SRenderPassDescription const &aDescription
                                          , Handles_t                    &aGpuApiHandles
                                          , TResourceManager             *aResourceManager
                                          , IVkGlobalContext             *aVulkanEnvironment);

            template <typename TResourceManager>
            static EEngineStatus deinitialize(SRenderPassDescription const &aDescription
                                            , Handles_t                    &aGpuApiHandles
                                            , TResourceManager             *aResourceManager
                                            , IVkGlobalContext             *aVulkanEnvironment);
        };
        ...
        //<-----------------------------------------------------------------------------
        template <typename TResourceManager>
        EEngineStatus SVulkanRenderPassResource::initialize(SRenderPassDescription const &aDescription
                                                          , Handles_t                    &aGpuApiHandles
                                                          , TResourceManager             *aResourceManager
                                                          , IVkGlobalContext             *aVulkanEnvironment)
        {
        ...
        //<-----------------------------------------------------------------------------
        template <typename TResourceManager>
        EEngineStatus SVulkanRenderPassResource::deinitialize(SRenderPassDescription const &aDescription
                                                            , Handles_t                    &aGpuApiHandles
                                                            , TResourceManager             *aResourceManager
                                                            , IVkGlobalContext             *aVulkanEnvironment)
        {
