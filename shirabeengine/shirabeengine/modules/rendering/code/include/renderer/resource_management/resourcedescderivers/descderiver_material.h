...
namespace engine
{
    namespace resources
    {
        ...
        template<>
        class CResourceAdapter<CMaterialInstance, SMaterialDescription>
        {
        public:
            static SMaterialDescription derive(Shared<CAssetStorage> aAssetStorage
                                               , Shared<CMaterialInstance> aInstance)
            {
                ...
                bool const includeSystemBuffers = isCoreMaterial;
                ...
                basePipelineDescriptor.includesSystemBuffers = includeSystemBuffers;

                configureInputAssembly(basePipelineDescriptor);
