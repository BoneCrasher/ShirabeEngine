...
if(SHIRABE_BUILD_APPLICATION)
	...
	set_target_properties(${SHIRABE_MODULE_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_DEBUG   ${SHIRABE_PROJECT_PUBLIC_DEPLOY_DIR}/bin)
	set_target_properties(${SHIRABE_MODULE_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_RELEASE ${SHIRABE_PROJECT_PUBLIC_DEPLOY_DIR}/bin)
elseif(SHIRABE_BUILD_STATICLIB)
	...
	set_target_properties(${SHIRABE_MODULE_NAME} PROPERTIES ARCHIVE_OUTPUT_DEBUG_DIRECTORY   ${SHIRABE_PROJECT_PUBLIC_DEPLOY_DIR}/lib)
	set_target_properties(${SHIRABE_MODULE_NAME} PROPERTIES ARCHIVE_OUTPUT_RELEASE_DIRECTORY ${SHIRABE_PROJECT_PUBLIC_DEPLOY_DIR}/lib)
...
if(SHIRABE_PROJECT_INCLUDEPATH)
	...
	file(GENERATE 
		OUTPUT "${SHIRABE_BUILD_DIR}/${SHIRABE_MODULE_NAME}_IncludePaths.txt" 
		CONTENT "$<TARGET_PROPERTY:${SHIRABE_MODULE_NAME},INTERFACE_INCLUDE_DIRECTORIES>\n"
		)
endif()
